...
| `homecoming-2026.jpg` | 6th Alumni Homecoming — Brotherhood for World Peace (Events) |

Use only letters, numbers, and hyphens in filenames (no `:` or `?`).

If Supabase still has `.png` paths, run `supabase/update-ad-images-to-jpg.sql` once.
